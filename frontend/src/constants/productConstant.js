// We can simply write strings in the actions and reducers but there could be chances of spelling mistakes
// But in this case we have to import these constants and if we change the spelling of the variable
// then this will give us error
